...
const PrivacyPage = () => {
  return (
    <>
      <Head>
        <title>Privacy - LFBI Volunteer Platform</title>
      </Head>
      <DefaultTemplate>
        <h1>Privacy Policy</h1>

        <p>
          Lagos Food Bank Initiative operates the Volunteer Platform website,
        ...
        <p>
          ...
          anyone decided to use our Service, the Volunteer Platform website.
        </p>

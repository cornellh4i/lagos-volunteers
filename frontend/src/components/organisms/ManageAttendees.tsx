...
const TabComponent: React.FC<TabProps> = ({ queryString, statusVar, enumVar }) => {
  ...
  const processedData = processAttendeesData(
    data,
    paginationModel
  );
...
const ManageAttendees = ({ }: ManageAttendeesProps) => {
  ...
  const tabs = [
    {
      label: "Pending",
      panel: <TabComponent queryString="are pending" statusVar="PENDING" enumVar="PENDING" />,
    },
    {
      label: "Checked in",
      panel: <TabComponent queryString="are checked in" statusVar="CHECKED_IN" enumVar="CHECKED_IN" />,
    },
    {
      label: "Checked out",
      panel: <TabComponent queryString="are checked out" statusVar="CHECKED_OUT" enumVar="CHECKED_OUT" />,
    },
    {
      label: "Registration canceled",
      panel: <TabComponent queryString="have canceled their registration" statusVar="REMOVED" enumVar="REMOVED" />
    },
    {
      label: "Registration removed",
      panel: <TabComponent queryString="have removed their registration" statusVar="CANCELED" enumVar="CANCELED" />
    },
  ];
